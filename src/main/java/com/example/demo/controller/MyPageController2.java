...
//		}
//		int cnt = reservationDao.cntByNo(member_no);	//예약현황횟수
...
////		//아이디와 비밀번호 맞는 지 체크
//		String a = memberDao.checkPwd(map)+"";
//		return a;
//	}
//	
//	
...
//	        }else {
//	           mav.setViewName("redirect:/myPage_7");
//	        }
//	         return mav;
//	      }
//	
...
//	      public ModelAndView post_myPage_3(HttpSession session,String oldpwd, String newpwd1) {
//	         ModelAndView mav = new ModelAndView();
//	         int member_no = -1;
//	         if(session.getAttribute("member_no") != null) {
//	            member_no = (int)session.getAttribute("member_no");
...
//	         MemberVo m = memberDao.getMember(member_no);
//	         
//	         HashMap map = new HashMap<>();            //입력한 비밀번호가 맞는비밀번호인지 확인
//	         map.put("id", m.getId());
//	         map.put("pwd", oldpwd);
//	         int a = memberDao.checkPwd(map);
//	         
//	         if( a == 1) {                  //입력한 비밀번호가 맞는 경우-> 새비밀번호로 수정
//	            HashMap map2 = new HashMap<>();
//	            map2.put("pwd",newpwd1);
//	            map2.put("member_no", member_no);
//	            int b = memberDao.newPwd(map2);      // 새로운 비밀번호로 수정
//	            if(b == 1) {                  // 수정 성공   
...
//			)
//	@ResponseBody
//	public List<AdviceVo> myPage_5_1(HttpSession session) {
//		int member_no = -1;
//		if(session.getAttribute("member_no") != null) {
//			member_no = (int)session.getAttribute("member_no");
//		}
//		List<AdviceVo> list = memberDao.myAdvice(member_no);		
//		return list;	
//	}

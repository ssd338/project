   ...
   $(document).on("click","#mypage_title_btn1",function check() {
    ...
    // 입력부분에 다 입력했는지 끝 -> 그럼 무사히 입력 다 된걸로 보고 입력값을 합쳐준다. */
      ...
      $("#delete_btn").click(function(){   
         $(".delete_text").remove();
         $("#open2").append(
         "<div class='delete_text'><p id='delete'>저희 율제병원 홈페이지는 실제 진료의 예약 등과 연계되기에 고객님이 직접 탈퇴처리 할 수 없습니다.<br>만약 회원 탈퇴를 원하실 경우 ‘상담 게시판’ 페이지를 통하여 본인의 ID, 주민번호, 연락 가능한 전화번호를 적어주십시오.<br>본인확인 후 탈퇴처리 해드립니다.<br>탈퇴하실 경우 그 동안 받으셨던 의료 상담 내역이나 진료 내역 등 본인과 관련된 모든 정보는 자동 삭제 됩니다.</p><a href='#close'>닫기</a></div>"
         );
                    ...
                    <div class="table_area">
                       <tbody>
                          ...
                          <div class="table_tr">
	                          <tr>
	                             ...
	                             <td>
		                            ...
		                            - <input type="text" id="tel2" value="${tel1 }">
		                            - <input type="text" id="tel3" value="${tel2 }">
                          ...
                          <tr>
                             ...
                             <td><div class="table_input">
	                             	<span id="table_span5">
	                             	<input type="text" id="addr1" value="${addr0 }" readonly="readonly">
                          ...
                          <tr>
                             <div class="table_input">
	                             <span id="table_span6"> 
	                             <input type="text" id="addr2" value="${addr1 }" readonly="readonly">
	                             </span><br>
                             </div>
                          </tr>
                          <tr>
                             <div class="table_input">
                             	<span id="table_span6"> 
                             	<input type="text" id="addr3" value="${addr2 }">
                             	</span>
                             </div>
                          </tr>
                          <tr>
